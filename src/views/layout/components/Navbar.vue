<template>
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
          <img class="user-avatar" src="/static/images/tools.png">
          <i class="el-icon-caret-bottom"></i>
        </div>
        <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <a href="/static/tools/produce.1.0.exe" download="produce.1.0.exe">生产类型选择器</a>
            </el-dropdown-item>
        </el-dropdown-menu>
      </el-dropdown>
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
    ...
    <div class="welcome">欢迎您：<span>{{introduction}}</span></div>
  </el-menu>
</template>
