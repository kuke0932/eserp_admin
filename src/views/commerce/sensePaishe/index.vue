<template>
  <div class="container">
    ...
    <div class="btn_box">
      ...
      <el-button class="el-button--danger hidden" code="remove" :disabled="editDisabled" @click="deleteResource" :loading="deleteLoading">
      ...
      <el-button class="el-button--primary hidden" code="revert" :disabled="editDisabled" @click="cancelCheck" :loading="revokeLoading">
    ...
    <el-dialog
      ...
      <el-form ref="addForm" :rules="rules" :model="addForm" label-width="80px" v-loading="addLoading" :element-loading-text="loadingText">
        <el-form-item label="资源类型" prop="type">
          <el-select v-model="addForm.type" placeholder="请选择" style="width: 100%" clearable filterable>
            <el-option
              v-for="item in categoryOption"
              :key="item.value"
              :label="item.label"
    ...
    <el-dialog
      ...
      <el-form ref="editForm" :rules="rules" :model="editForm" label-width="80px" v-loading="editLoading" :element-loading-text="loadingText">
        <el-form-item label="资源类型" prop="type">
          <el-select v-model="editForm.type" placeholder="请选择" clearable filterable>
            <el-option
              v-for="item in categoryOption"
              :key="item.value"
              :label="item.label"
...
<script>
  ...
  import { list, save, update, remove, getById, updateAuditStatus, checkDownloadCode } from '@/api/sensePaishe'
