    ...
    <el-row style="border-bottom: 0;" class="my-el-row">
      ...
      <el-col :span="19" style="margin-left: 20px; padding-top: 37px;">
        <el-form :inline="true" :model="searchForm" ref="searchForm"  class="searchForm">
          <el-row>
              <el-form-item label-width="70px" label="角色名" prop="searchRoleName">
                <el-input clearable style="width: 162px;" v-model="searchForm.searchRoleName" ></el-input>
              </el-form-item>
              <el-form-item label-width="80px" label="角色值" prop="searchRoleValue">
                <el-input clearable style="width: 162px;" v-model="searchForm.searchRoleValue"></el-input>
              </el-form-item>
            ...
            <el-row>
              <el-col :span="8">
                <el-form-item label-width="70px" label="角色名">
                  <el-input clearable style='min-width:120px;' v-model="searchUnRoleName"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="9">
                <el-form-item label-width="80px" label="角色值">
                  <el-input clearable style='min-width:120px;' v-model="searchUnRoleValue"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="3">
