<template>
  <div class="container">
    <el-form class="searchForm" :inline="true" :model="searchForm" ref="searchForm">
      <el-row>
        <el-form-item label="角色名" label-width="63px" prop="searchRoleName">
          <el-input clearable v-model="searchForm.searchRoleName"></el-input>
        </el-form-item>
        <el-form-item label="角色值" label-width="63px" prop="searchRoleValue">
          <el-input clearable v-model="searchForm.searchRoleValue"></el-input>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form ref="addForm" :rules="rules" :model="addForm" label-width="80px"
        ...
        <el-form-item label="角色值" prop="roleValue">
          <el-input clearable v-model="addForm.roleValue"></el-input>
        </el-form-item>
        <el-form-item label="角色描述" prop="roleDesc">
          <el-input clearable type="textarea" v-model="addForm.roleDesc"></el-input>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form ref="editForm" :rules="rules" :model="editForm" label-width="80px"
               ...
               :element-loading-text="loadingText">
        <el-form-item label="角色名" prop="roleName">
          <el-input clearable v-model="editForm.roleName"></el-input>
        </el-form-item>
        <el-form-item label="角色值" prop="roleValue">
          <el-input clearable v-model="editForm.roleValue" disabled></el-input>
        </el-form-item>
        <el-form-item label="角色描述" prop="roleDesc">
          <el-input clearable type="textarea" v-model="editForm.roleDesc"></el-input>
        </el-form-item>
        <el-form-item class="btn_box">
  ...
  export default {
    ...
    methods: {
      ...
      handleSizeChange(pageSize) {
        ...
        this.fetchData(this.searchForm.searchRoleName, this.searchForm.searchRoleValue, this.pageNum, this.pageSize)
      },
      /* table表格当前页事件 */
      ...
      search() {
        ...
        this.fetchData(this.searchForm.searchRoleName, this.searchForm.searchRoleValue, this.pageNum, this.pageSize).then((resp) => {
