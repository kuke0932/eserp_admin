      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label-width="70px" label="登录名">
            <el-input clearable style='min-width:120px;' v-model="searchLoginName"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="9">
          <el-form-item label-width="80px" label="用户昵称">
            <el-input clearable style='min-width:120px;' v-model="searchUserName"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="3">
          ...
          <el-col :span="18">
            <el-form>
              <el-row>
                <el-col :span="8">
                  <el-form-item label-width="70px" label="登录名">
                    <el-input clearable v-model="searchUnLoginName" style='min-width:120px;'></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="9">
                  <el-form-item label-width="80px" label="用户昵称">
                    <el-input clearable v-model="searchUnUserName" style='min-width:120px;'></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="3">
