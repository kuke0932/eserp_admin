  ...
  <div class="container my-container">
    <el-row style="border-bottom: 0;" class="my-el-row">
      ...
      <el-col :span="19" style="margin-left: 20px; padding-top: 37px;">
          <el-form ref="searchForm"  class="searchForm" :inline="true" :model="searchForm">
            <el-row>
                <el-form-item label-width="80px" label="部门名称" prop="searchDepartmentName">
                  <el-input clearable v-model="searchForm.searchDepartmentName" style="width: 162px;"></el-input>
                </el-form-item>
                <el-form-item label-width="80px" label="部门类型" prop="searchDepartmentType">
                  <el-select :clearable="true" v-model="searchForm.searchDepartmentType" style="width: 162px;" placeholder="请选择" clearable filterable>
                    <el-option
    ...
    <el-dialog
      ...
      <el-form ref="addForm" :rules="rules" :model="addForm" label-width="80px"
        ...
        <el-form-item label="部门名" prop="departmentName">
          <el-input clearable v-model="addForm.departmentName"></el-input>
        </el-form-item>
        <el-form-item label="父部门" prop="parentName">
          <el-input clearable v-model="addForm.parentName"  v-popover:popoverTree readonly></el-input>
        </el-form-item>
        ...
        <el-form-item label="部门描述" prop="departmentDesc">
          <el-input clearable type="textarea" v-model="addForm.departmentDesc"></el-input>
        </el-form-item>
    ...
    <el-dialog
      ...
      <el-form ref="editForm" :rules="rules" :model="editForm" label-width="78px"
               ...
               :element-loading-text="loadingText">
        <el-form-item label="部门名" prop="departmentName">
          <el-input clearable v-model="editForm.departmentName"></el-input>
        </el-form-item>
        <br />
        <el-form-item label="父部门" prop="parentName">
          <el-input clearable v-model="editForm.parentName"  v-popover:popoverTree readonly></el-input>
        </el-form-item>
        <br />
        <el-form-item label="部门类型" prop="departmentType">
        ...
        <br />
        <el-form-item label="部门描述" prop="departmentDesc">
          <el-input clearable type="textarea" v-model="editForm.departmentDesc"></el-input>
        </el-form-item>
        <br />
        <el-form-item class="btn_box">
  ...
  export default {
    ...
    methods: {
      ...
      currentNodeClick(current, node) {
        ...
        this.fetchData(current.id, this.searchForm.searchDepartmentName, this.searchForm.searchDepartmentType, this.pageNum, this.pageSize)
        if (current.id === 1) {
      ...
      search() {
        ...
        this.listLoading = true
        this.fetchData(this.currentId, this.searchForm.searchDepartmentName, this.searchForm.searchDepartmentType, this.pageNum, this.pageSize).then((resp) => {
      ...
      handleSizeChange(pageSize) {
        ...
        this.fetchData(this.parentId, this.searchForm.searchDepartmentName, this.searchForm.searchDepartmentType, this.pageNum, this.pageSize)
      },
      handleCurrentPageChange(currentPage) {
        this.pageNum = currentPage
        this.fetchData(this.currentId, this.searchForm.searchDepartmentName, this.searchForm.searchDepartmentType, this.pageNum, this.pageSize)
      },
      /* 修改选择当前点击部门 */
