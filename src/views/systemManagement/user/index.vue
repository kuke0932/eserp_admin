    ...
    <el-col :span="19" style="margin-left: 20px; padding-top: 37px;">
      <el-form ref="searchForm"  class="searchForm" :inline="true" :model="searchForm">
        <el-row>
            <el-form-item label-width="70px" label="登录名" prop="searchLoginName">
              <el-input clearable v-model="searchForm.searchLoginName" style="width: 162px;"></el-input>
            </el-form-item>
            <el-form-item label-width="80px" label="用户昵称" prop="searchUserName">
              <el-input clearable v-model="searchForm.searchUserName" style="width: 162px;"></el-input>
            </el-form-item>
      ...
      <el-dialog
        ...
        <el-form ref="addForm" :rules="rules" :model="addForm" label-width="80px"
          ...
          <el-form-item label="手机号" prop="mobile">
            <el-input clearable v-model="addForm.mobile" maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')"></el-input>
          </el-form-item>
          <el-form-item label="座机号" prop="telephone">
            <el-input clearable v-model="addForm.telephone" maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')"></el-input>
          </el-form-item>
      ...
      <el-dialog
        ...
        <el-form ref="editForm"
          ...
          <el-form-item label="手机号" prop="mobile">
            <el-input clearable v-model="editForm.mobile" maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')"></el-input>
          </el-form-item>
          <el-form-item label="座机号" prop="telephone">
            <el-input clearable v-model="editForm.telephone" maxlength="11" onkeyup="this.value=this.value.replace(/[^0-9.]/g,'')"></el-input>
          </el-form-item>
          <el-form-item label="电子邮箱" prop="email">
      ...
      <view-manage-department :visible.sync="setManageDepartmentVisible" :userId="userId" v-on:closeViewMenu="closeViewMenu"></view-manage-department>
      ...
      <el-dialog
        ...
        <el-form ref="resetPasswordForm" :rules="resetRules" :model="resetPasswordForm" label-width="80px"
                 ...
                 :element-loading-text="loadingText">
          <el-form-item label="密码" prop="loginPwd">
            <el-input clearable type="password" v-model="resetPasswordForm.loginPwd" onfocus="changeIptType()" auto-complete="off" placeholder="请输入6位以上密码"></el-input>
          </el-form-item>
          <el-form-item>
...
<script>
  ...
  import ViewManageDepartment from './viewManageDepartment'
  import { listRole } from '@/api/role'
  export default {
    name: 'user',
    components: {
      ViewManageDepartment
    },
    data() {
      return {
        treeHeight: 0,
