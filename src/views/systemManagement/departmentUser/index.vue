  ...
  <div class="container">
    ...
    <el-col :span="18">
      <el-form>
        <el-row>
          <el-col :span="8">
            <el-form-item label-width="70px" label="登录名">
              <el-input clearable v-model="searchLoginName" style='min-width:120px;'></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="9">
            <el-form-item label-width="80px" label="用户昵称">
              <el-input clearable v-model="searchUserName" style='min-width:120px;'></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="3">
        ...
        <div class="btn_box">
          <el-button class="el-button--primary" code="add" @click="goAddUser">添加用户</el-button>
          <el-button class="el-button--primary" :disabled="editDisabled" code="edit" @click="goEditUser">修改用户</el-button>
          <el-button class="el-button--danger hidden" :disabled="editDisabled" code="remove" @click="deleteUser">删除用户</el-button>
        </div>
        <el-dialog
          title="添加用户"
          ...
          <el-form ref="addForm" :rules="rules" :model="addForm" label-width="80px">
            <el-form-item label="登录名" prop="loginName">
              <el-input clearable v-model="addForm.loginName"></el-input>
            </el-form-item>
            <el-form-item label="密码" prop="loginPwd">
              <el-input clearable type="password" v-model="addForm.loginPwd"></el-input>
            </el-form-item>
            <el-form-item label="部门" prop="department">
              <el-input clearable v-model="addForm.department" v-popover:popoverTree readonly></el-input>
            </el-form-item>
        ...
        <el-dialog
          ...
          <el-form ref="editForm" :rules="rules" :model="editForm" label-width="80px">
            <el-form-item label="登录名">
              <el-input clearable v-model="editForm.loginName" readonly></el-input>
            </el-form-item>
            <el-form-item label="部门" prop="department">
              <el-input clearable v-model="editForm.department" v-popover:popoverTree readonly></el-input>
            </el-form-item>
            <el-form-item label="用户昵称" prop="userName">
              <el-input clearable v-model="editForm.userName"></el-input>
            </el-form-item>
            <el-form-item label="手机号" prop="mobile">
        ...
        <el-table
          ...
          <el-table-column label="操作" fixed="right" width="200">
            <template slot-scope="scope">
              <el-button  class="hidden" style="margin-left: 10px;" type="primary" code="on_off" size="small"  @click="checkStatus(scope.$index, scope.row.id, scope.row.enableStatus)">
        ...
        <el-dialog
          ...
          <el-form ref="resetPasswordForm" :rules="resetRules" :model="resetPasswordForm" label-width="80px">
            <el-form-item label="密码" prop="loginPwd">
              <el-input clearable type="password" v-model="resetPasswordForm.loginPwd" auto-complete="off" placeholder="请输入6位以上密码"></el-input>
            </el-form-item>
            <el-form-item>
...
<script>
  import { addUser, updateUser,
    removeUser, getUserById, listDepartmentUser,
  ...
  export default {
    ...
    methods: {
      ...
      handleNodeClick(data) {
        ...
        this.fetchData(this.departmentId, '', '', this.pageNum, this.pageSize)
      },
      /* 初始化部门树 */
      initDepartmentTree() {
      ...
      /* 获取部门下用户信息 */
      fetchData(departmentId, loginName, userName, pageNum, pageSize) {
      ...
      handleCurrentPageChange(currentPage) {
        ...
        this.fetchData(this.departmentId, this.searchLoginName, this.searchUserName, this.pageNum, this.pageSize)
      },
      /* 打开重置密码窗口 */
      edit(userId) {
        this.userId = userId
