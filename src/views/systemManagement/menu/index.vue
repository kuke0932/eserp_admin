  ...
  <div class="container my-container">
    <el-row class="my-el-row">
      ...
      <el-col :span="19" style="margin-left: 20px;">
        ...
        <div class="btn_box" style="margin-top: 23px;margin-bottom: 21px;">
          <el-button class="el-button--primary" size="small" code="add" @click="goAddMenu"><i class="el-icons-jd-add"></i>&nbsp;添加菜单</el-button>
          <el-button class="el-button--primary" size="small" code="edit" :disabled="editDisabled" :loading="editLoading" @click="goEditMenu"><i class="el-icons-jd-xiugai1"></i>&nbsp;修改菜单</el-button>
          <el-button class="el-button--danger" size="small" code="remove" :disabled="editDisabled" :loading="removeLoading" @click="deleteMenu"><i class="el-icons-jd-shanchu"></i>&nbsp;删除菜单</el-button>
        </div>
        <el-dialog
          title="添加菜单"
          ...
          <el-popover
            ...
            <el-tree
              ...
              <span class="custom-tree-node" slot-scope="{ node, data }">
                ...
                <span v-if="data.id === parentMenuId" >
                  <el-button
                    type="text"
                    size="mini"
                    @click.stop="closePopperAdd(data)">
                    确定
                  </el-button>
                </span>
              </span>
          ...
          <el-form ref="addForm" :model="addForm" :rules="addRules" label-width="170px"
                   v-loading="addFormLoading"
                   :element-loading-text="loadingText">
            <el-form-item label="菜单名" prop="menuName">
              <el-input clearable v-model="addForm.menuName"></el-input>
            </el-form-item>
            <el-form-item label="父菜单" prop="parentMenu">
              <el-input clearable v-popover:popoverTreeAdd readonly v-model="addForm.parentMenu"></el-input>
            </el-form-item>
            <el-form-item label="菜单地址" prop="menuAddr">
              <el-input clearable v-model="addForm.menuAddr"></el-input>
            </el-form-item>
            <el-form-item label="菜单类型" prop="menuType">
              <el-select v-model="addForm.menuType" @change="addMenuTypeChange" placeholder="请选择" clearable filterable>
            ...
            <el-form-item label="菜单图标" prop="menuIcon" v-show="addForm.menuType == 1">
              <el-input clearable v-model="addForm.menuIcon"></el-input>
            </el-form-item>
            <el-form-item label="是否显示在左侧导航栏" prop="isVisible" v-show="addForm.menuType == 1">
              <el-select v-model="addForm.isVisible" placeholder="请选择" clearable filterable>
                <el-option label="是" :value="1" :key="1"></el-option>
                <el-option label="否" :value="0" :key="0"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="按钮code" prop="menuCode" v-show="addForm.menuType == 2">
              <el-input clearable v-model="addForm.menuCode"></el-input>
            </el-form-item>
            <el-form-item label="菜单顺序" prop="menuOrder">
              <el-input clearable v-model="addForm.menuOrder"></el-input>
            </el-form-item>
        ...
        <el-popover
          ...
          <el-tree
            ...
            <span class="custom-tree-node" style="width: 300px; line-height: 26px; display: block;" slot-scope="{ node, data }">
              <span>{{ node.label }}</span>
              <span style="display: block; float: right; margin-right: 10px;" v-if="data.id === parentMenuId" >
                <el-button
                  type="text"
                  size="mini"
                  @click.stop="closePopperEdit(data)">
                  确定
                </el-button>
              </span>
            </span>
        ...
        <el-form ref="editForm" :model="editForm" :rules="rules" label-width="160px"
                 ...
                 :element-loading-text="loadingText">
          <el-form-item label="菜单名" prop="menuName">
            <el-input clearable :readonly="isReadonly" v-model="editForm.menuName" style="width: 558px"></el-input>
          </el-form-item>
          <el-form-item label="父菜单" prop="parentMenu">
            <el-input clearable v-model="editForm.parentMenu" readonly v-popover:popoverTreeEdit style="width: 558px"></el-input>
          </el-form-item>
          <el-form-item label="菜单地址" prop="menuAddr">
            <el-input clearable :readonly="isReadonly" v-model="editForm.menuAddr" style="width: 558px"></el-input>
          </el-form-item>
          <el-form-item label="菜单类型" prop="menuType">
            <el-select :disabled="isReadonly" v-model="editForm.menuType" @change="editMenuTypeChange" placeholder="请选择" style="width: 558px" clearable>
              <el-option label="菜单" :value="1" :key="1"></el-option>
              <el-option label="按钮" :value="2" :key="2"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="菜单图标" prop="menuIcon" v-show="editForm.menuType == 1">
            <el-input clearable :readonly="isReadonly" v-model="editForm.menuIcon" style="width: 558px"></el-input>
          </el-form-item>
          <el-form-item label="是否显示在左侧导航栏" prop="isVisible" v-show="editForm.menuType == 1">
            <el-select :readonly="isReadonly" v-model="editForm.isVisible" placeholder="请选择" style="width: 558px" clearable>
              <el-option label="是" :value="1" :key="1"></el-option>
              <el-option label="否" :value="0" :key="0"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="按钮code" prop="menuCode" v-show="editForm.menuType == 2">
            <el-input clearable :readonly="isReadonly" v-model="editForm.menuCode" style="width: 558px"></el-input>
          </el-form-item>
          <el-form-item label="菜单顺序" prop="menuOrder">
            <el-input clearable :readonly="isReadonly" v-model="editForm.menuOrder" style="width: 558px"></el-input>
          </el-form-item>
    ...
    methods: {
      ...
      getCurrentObj(obj, node) {
        ...
        getFunctionById(this.currentId).then(response => {
          ...
          this.editForm.isVisible = response.data.data.isVisible
      ...
      closePopperAdd(data) {
        ...
        this.addForm.parentMenu = data.label
        this.showPopperAdd = false
      },
      closePopperEdit(data) {
        this.parentMenuId = data.id
        this.editForm.parentMenu = data.label
        this.showPopperEdit = false
      },
      /* 修改选择父菜单 */
      ...
      addMenuTypeChange(val) {
        if (val === 1) {
          ...
          this.addRules.isVisible = [
            { required: true, message: '请选择是否显示在左侧导航栏', trigger: 'change' }
          ]
        } else {
          this.addRules.menuIcon = []
          this.addRules.isVisible = []
