  ...
  <div class="container">
    <el-form ref="searchForm" class="searchForm" :inline="true" :model="searchForm">
      <el-row :gutter="20">
        <el-form-item label="类型" prop="type" style="float: left">
          <el-select v-model="searchForm.type" clearable @change="changeType" filterable>
        ...
        <el-form-item label-width="10px" prop="rawMaterialType" style="float: left" v-if="searchForm.type === 1">
          <el-select v-model="searchForm.rawMaterialType" clearable filterable>
    ...
    <el-dialog
      ...
      <el-form ref="addForm" :rules="rules" :model="addForm" label-width="100px"
        ...
        <div style="overflow: hidden;">
          <el-form-item label="类型" prop="type"  style="float: left">
            <el-select v-model="addForm.type"  placeholder="请选择类型" clearable filterable>
              <el-option v-for="item in materialTypeList"
                         :key="item.value"
                         :label="item.name"
                         :value="item.value">
          ...
          <el-form-item label-width="10px" prop="rawMaterialType" style="float: left" v-if="addForm.type === 1">
            <el-select v-model="addForm.rawMaterialType" clearable v-if="addForm.type === 1" clearable filterable>
              <el-option v-for="item in rawMaterialList"
                         :key="item.value"
                         :label="item.name"
                         :value="item.value">
    ...
    <el-dialog
      ...
      <el-form ref="editForm" :rules="rules" :model="editForm" label-width="100px"
        ...
        <div style="overflow: hidden;">
          <el-form-item label="类型" prop="type" style="float: left">
            <el-select v-model="editForm.type"  placeholder="请选择类型" @change="changeType" clearable filterable>
              <el-option v-for="item in materialTypeList"
                         :key="item.value"
                         :label="item.name"
                         :value="item.value">
          ...
          <el-form-item label-width="10px" prop="rawMaterialType" style="float: left" v-if="editForm.type === 1">
            <el-select v-model="editForm.rawMaterialType" clearable v-if="editForm.type === 1" filterable>
              <el-option v-for="item in rawMaterialList"
                         :key="item.value"
                         :label="item.name"
                         :value="item.value">
...
<script>
  ...
  export default {
    ...
    beforeRouteUpdate(to, from, next) {
      ...
      this.fetchData(this.searchForm.type, null, null, this.pageNum, this.pageSize)
      next()
    },
    watch: {
      dataList() {
    ...
    mounted() {
      ...
      if (this.searchForm.type === 1) {
        type = this.searchForm.rawMaterialType || this.searchForm.type
      }
      this.fetchData(type, null, null, this.pageNum, this.pageSize)
    },
    methods: {
      /* 查询物料规格列表 */
      fetchData(type, specificationName, specificationCode, pageNum, pageSize) {
      ...
      handleCurrentPageChange(currentPage) {
        ...
        this.fetchData(
          ...
          this.searchForm.specificationName,
          this.searchForm.specificationCode,
          this.pageNum,
          this.pageSize
        )
      },
