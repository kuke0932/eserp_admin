...
<script>
  ...
  export default {
    ...
    watch: {
      areaType: {
        handler(e) {
          this.fetchData(this.searchForm.materialType, null, null, this.searchForm.typeCode, this.searchForm.color, this.pageNum, this.pageSize)
        }
      },
      departmentId: {
        handler(e) {
      ...
      materialType() {
        this.searchForm.materialType = this.materialType
      }
    },
    mounted() {
      this.fetchData(this.searchForm.materialType, null, null, this.searchForm.typeCode, this.searchForm.color, this.pageNum, this.pageSize)
